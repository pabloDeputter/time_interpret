...
class Mimic3(DataModule):
    ...
    def download(
        ...
        # Assume that preprocessed file already exists
        if os.path.exists('/Users/pablodeputter/Desktop/ContraLSP/mortalty/patient_vital_preprocessed.pkl'):
            with open(
                "/Users/pablodeputter/Desktop/ContraLSP/mortalty/patient_vital_preprocessed.pkl",
                "rb",
            ) as f:
                samples = pkl.load(f)
